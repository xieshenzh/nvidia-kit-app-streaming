# Deployment Policy Check: isaac-sim

**Total: 36** | Critical: 0 | High: 5 | Medium: 7 | Low: 24

# Deployment Policy Check: isaac-sim: `client` (namespace: `isaac-sim-streaming`)
...
- Namespace has name 'isaac-sim-streaming'
...
# Deployment Policy Check: isaac-sim: `coturn` (namespace: `isaac-sim-streaming`)
...
# Deployment Policy Check: isaac-sim: `isaac-sim` (namespace: `isaac-sim-streaming`)

**Total: 15** | Critical: 0 | High: 2 | Medium: 2 | Low: 11
